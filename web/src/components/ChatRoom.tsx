  ...
  return (
    <div className="flex-1 flex flex-col" style={{ background: th.bgFlat }}>
      ...
      {conv?.pinnedMessages && conv.pinnedMessages.length > 0 && (
        <div style={{ background: th.navBg, borderBottom: `1px solid ${th.divider}` }}>
      ...
      {/* Messages */}
      <div className="flex-1 overflow-y-auto px-2 py-2 space-y-0.5" style={{ background: th.bg }}>
        {loading && (
      ...
      {/* Edit bar */}
      {editingMessage && (
        <div className="px-4 py-2 flex items-center gap-3" style={{ background: th.navBg, borderTop: `1px solid ${th.divider}` }}>
      ...
      {(pendingAttachment || uploading) && (
        <div className="px-4 py-2" style={{ background: th.navBg, borderTop: `1px solid ${th.divider}` }}>
      ...
      {/* Input */}
      <div style={{ background: th.navBg, backdropFilter: 'blur(14px)', WebkitBackdropFilter: 'blur(14px)', borderTop: `1px solid ${th.divider}` }}>
        {isRecordingVoice ? (
          <VoiceRecorder
            onSend={(att) => {
