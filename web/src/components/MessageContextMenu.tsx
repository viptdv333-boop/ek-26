...
const ICONS: Record<string, JSX.Element> = {
  reply: <path strokeLinecap="round" strokeLinejoin="round" d="M9 15L3 9m0 0l6-6M3 9h12a6 6 0 010 12h-3" />,
  ...
  mute: <path strokeLinecap="round" strokeLinejoin="round" d="M17.25 9.75L19.5 12m0 0l2.25 2.25M19.5 12l2.25-2.25M19.5 12l-2.25 2.25m-10.5-6l4.72-4.72a.75.75 0 011.28.53v15.88a.75.75 0 01-1.28.53l-4.72-4.72H4.51c-.88 0-1.704-.507-1.938-1.354A9.01 9.01 0 012.25 12c0-.83.112-1.633.322-2.396C2.806 8.756 3.63 8.25 4.51 8.25H6.75z" />,
...
export function MessageContextMenu({ x, y, items, onClose, reactions, onReact }: Props) {
  ...
  return (
    <div className="fixed inset-0 z-40" onClick={onClose} onContextMenu={(e) => { e.preventDefault(); onClose(); }}>
      <div
        className="absolute bg-dark-700 border border-dark-500 rounded-xl shadow-xl py-1 min-w-[180px] overflow-hidden"
          ...
          <button
            ...
            className={`w-full flex items-center gap-3 px-4 py-2.5 text-sm transition-colors ${
              item.danger
                ...
                : 'text-gray-200 hover:bg-dark-600'
            }`}
          >
